...
const projects = [
  ...
  },
  {
    ...
    description:
      "A full stack Next.JS app where you can interact with philosophers of the old times and can know about their ideas from their own tongue. You can also subscribe for Philosophy Pro for higher message limit",
    stack: ["Next.js", "Tailwind CSS", "MySQL", "Prisma", "SSE"],
    year: "2026",
    href: "https://github.com/izhanwk/Philosophy-Ai",
    live: "https://philosophy-ai-1bpi.vercel.app/",
  },
  {
...
const capabilities = [
  ...
  },
  {
    ...
    items: ["Next JS", "Node JS", "Express JS", "Mongo DB", "My SQL", "Prisma"],
  },
  {
    title: "Web Scraping",
    caption:
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-blue-900/20 via-transparent to-transparent" />

      <div className="pointer-events-none absolute -top-40 right-0 h-[300px] w-[300px] sm:h-[600px] sm:w-[600px] rounded-full bg-linear-to-br from-blue-500/10 to-cyan-500/10 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 left-0 h-[200px] w-[200px] sm:h-[400px] sm:w-[400px] rounded-full bg-linear-to-tr from-emerald-500/10 to-blue-500/10 blur-3xl" />
      ...
      <main className="relative mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-20 lg:px-16">
        <header className="grid gap-12 lg:grid-cols-[1.3fr_0.7fr] lg:gap-20 lg:items-start mb-20 sm:mb-32">
          <div className="space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-4xl sm:text-5xl font-bold leading-[1.1] tracking-tight text-white lg:text-7xl">
                Izhan.
                <span className="text-4xl sm:text-5xl font-bold leading-[1.1] tracking-tight bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent lg:text-7xl">
                  Dev
                </span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-4">
              <a
                className="group inline-flex items-center justify-center gap-3 rounded-full bg-linear-to-r from-blue-600 to-cyan-600 px-6 sm:px-8 py-3 sm:py-4 font-semibold text-white shadow-lg shadow-blue-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/40 hover:scale-[1.02] focus-visible:outline  focus-visible:outline-offset-2 focus-visible:outline-blue-500 text-sm sm:text-base"
                href="#projects"
              >
                View Projects
              ...
              <a
                className="inline-flex items-center justify-center gap-3 rounded-full border border-slate-700 bg-slate-800/50 px-6 sm:px-8 py-3 sm:py-4 font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-slate-600 hover:bg-slate-800 focus-visible:outline  focus-visible:outline-offset-2 focus-visible:outline-slate-500 text-sm sm:text-base"
                href="#contact"
              >
                Get in Touch
              </a>
          ...
          <div className="relative lg:sticky lg:top-20 mt-8 lg:mt-0">
            <div className="absolute -inset-2 sm:-inset-4 rounded-4xl sm:rounded-[3rem] bg-linear-to-br from-blue-500/20 to-cyan-500/20 blur-2xl" />
            <div className="relative rounded-4xl sm:rounded-[2.5rem] border border-white/10 bg-linear-to-br from-slate-800/90 to-slate-900/90 p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
                ...
                {[
                  {
                    label: "Front End",
                    content:
                      "TypeScript, React.js, Next.js, Redux, Tailwind CSS",
                  },
                  {
                    label: "Backend",
                    content:
                      "Node.js, Express.js, Server Sent Events (SSE), SQL/nonSQL, Prisma",
                  },
                  {
                    label: "Other",
                  ...
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
                    {project.live && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 rounded-full bg-linear-to-r from-emerald-600 to-emerald-500 px-4 sm:px-5 py-2 text-xs sm:text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/40 hover:scale-105"
                      >
                        Live Link
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
            {capabilities.map((capability, index) => (
              <article
                ...
                className="group rounded-2xl sm:rounded-3xl border border-white/5 bg-linear-to-br from-slate-800/40 to-slate-900/40 p-6 sm:p-8 backdrop-blur-sm transition-all duration-500 hover:border-white/20 hover:bg-slate-800/60"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <h3 className="text-xl sm:text-2xl font-bold text-white transition-colors group-hover:text-blue-300">
                  {capability.title}
        ...
        <section
          id="contact"
          className="relative overflow-hidden rounded-4xl sm:rounded-[3rem] border border-white/10 
  bg-linear-to-br from-blue-900/20 via-slate-800/40 to-slate-900/40
  p-6 sm:p-10 lg:p-16 backdrop-blur-xl"
    ...
    bg-linear-to-br from-blue-500/20 to-cyan-500/20 blur-3xl"
          />

          <div
            className="absolute -bottom-10 sm:-bottom-20 -left-10 sm:-left-20 h-32 sm:h-64 w-32 sm:w-64 rounded-full 
    bg-linear-to-tr from-emerald-500/20 to-blue-500/20 blur-3xl"
          />
